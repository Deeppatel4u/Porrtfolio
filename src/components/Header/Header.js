...
import { AiFillEye, AiFillGithub, AiFillInstagram, AiFillLinkedin, AiFillYoutube } from 'react-icons/ai';
...
const Header = () =>  (
  <Container>
    <Div1>
      <Link href = "/">
        <a style = {{display: "flex", alighItems:"center", color:  "white", marginBottom: "20,"}}>
